...
extern "C" {
    ...
    #[deprecated(
        since = "0.2.183",
        note = "This function, among other older functions in the CRT, were marked deprecated and \
               have more secure variants with the same symbols but `_s`-suffixed. If you use this \
               specific routine, we're requesting comments at #PENDING."
    )]
